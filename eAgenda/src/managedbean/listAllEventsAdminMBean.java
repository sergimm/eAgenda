 ...
 */
@ManagedBean(name = "eventAdminList")
@SessionScoped
public class listAllEventsAdminMBean implements Serializable{
	...
	//private List<CategoryJPA> categoriesEvent = new ArrayList<CategoryJPA>();
	
	public listAllEventsAdminMBean() throws Exception {
